...
public interface ITableData<TId> : IEquatable<ITableData<TId>>// where TId : IParsable<TId>, IEquatable<TId>
{
    TId Id { get; set; }
// }
...
/// </remarks>
// public interface ITableData : ITableData<Guid>, IEquatable<ITableData>
// {
     /// <summary>
