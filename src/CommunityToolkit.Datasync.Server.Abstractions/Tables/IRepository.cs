...
public interface IRepository<TEntity, TKey> where TEntity : ITableData<TKey>
{
    /// <summary>
    ...
    /// <exception cref="HttpException">Thrown if the entity creation would produce a normal HTTP error.</exception>
    /// <exception cref="RepositoryException">Thrown is there is an error in the repository.</exception>
    ValueTask DeleteAsync(TKey id, byte[]? version = null, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="HttpException">Thrown if the entity creation would produce a normal HTTP error.</exception>
    /// <exception cref="RepositoryException">Thrown is there is an error in the repository.</exception>
    ValueTask<TEntity> ReadAsync(TKey id, CancellationToken cancellationToken = default);
...
public interface IRepository<TEntity> : IRepository<TEntity, string> where TEntity : ITableData<string>;